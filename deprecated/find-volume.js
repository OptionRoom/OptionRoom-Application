...
var init = async () => {
    const marketAddress = "0x4d34C335b0372235E8D9d6C80B3Fb6A3Dc0400e8";
    const endBlockNumber = 8756616;
    let allEvents = [];
    ...
    const callEvents = async (currentBlockNumber) => {
        const fromBlockToBlock = {
            fromBlock: currentBlockNumber - 5000,
...
/*        allEvents = allEvents.concat(buyEvents);
        allEvents = allEvents.concat(sellEvents);*/
    }
