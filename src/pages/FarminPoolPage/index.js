...
const getPageConfig = (source, pool) => {
    if (source === 'room' && pool === "CourtFarming_RoomStake") {
        return {
            ...
            details: "Earn COURT tokens by staking your ROOM tokens on this page.",
        };
    }
    ...
    if (source === 'room_eth_lp' && pool === "CourtFarming_RoomEthLpStake") {
        return {
            title: "Liquidity Farming",
            details: "Earn COURT tokens by providing liquidity to the ROOM/ETH pair on Uniswap and staking your LP tokens on this page.",
        };
    }
    ...
    if (source === 'court_eth_lp' && pool === "CourtFarming_CourtEthLpStake") {
        return {
            title: "Liquidity Farming",
            details: "Earn COURT tokens by providing liquidity to the COURT/ETH pair on Uniswap and staking your LP tokens on this page.",
        };
    }
};
...
function FarminPoolPage(props) {
    ...
    return (
        <>
            <Navbar title={getPageConfig(source, pool).title}
